//////////////src/sc-store/sc-event/sc_event_private.h////////////////
...
///////src/sc-store/sc_event_subscription.c/////////////////
 ...
 */
     ...
     )
 {
   ...
   if (is_complex_event_subscription){
       ...
       event_subscription->cond_increase = null_ptr;
       event_subscription->cond_decrease = null_ptr;
 ...
 sc_result sc_event_subscription_destroy(sc_event_subscription * event_subscription)
 {
   ...
   if (event_subscription->is_complex_event_subscription){
       ...
       if (!sc_list_destroy(&event_subscription->events_list))
           return SC_RESULT_ERROR;
       event_subscription->is_complex_event_subscription = false;
       event_subscription->complex_event_subscription_waits_simple_events = false;
   }
   ...
   while (element_events_list != null_ptr)
   {
       ...
       if (!sc_event_subscription_is_complex(event_subscription) &&
           event_subscription->events_list != null_ptr)
         {
           ...
           {
               sc_list *events_list_temp = event_subscription->events_list;
               
               while (events_list_temp != null_ptr)
                {
                   sc_event_subscription *complex_event_subscription = 
                       (sc_event_subscription *)events_list_temp->data;
                   
                   if (complex_event_subscription == null_ptr) {
                       events_list_temp = events_list_temp->next;
                       continue;
                   }
...
/////////////////src/sc-store/sc-event/sc_event_queue.c////////////////////
