...
def sum_of_binaries(num1: int, num2: int):
    _ , first_binary  = convert_to_binary(num1)
    _ , second_binary  = convert_to_binary(num2)
...
def difference_of_binaries(num1: int, num2: int):
    num2 *= -1
    return sum_of_binaries(num1, num2)




sum = sum_of_binaries(45,9)
tput = ''.join(map(str,sum))
print(tput)
convert_to_10(sum)


dif = difference_of_binaries(15,6)
put = ''.join(map(str,dif))
print(put)
convert_to_10(dif)